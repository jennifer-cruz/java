...
public class Menu {
	...
	public static void main(String[] args) {
		...
		Conta c1 = new Conta(1, 123, 1, "Cliente 01", 30000.0f);
...
//visualizamos apenas o saldo da conta c1
		...
		// criamos a conta c2
		Conta c2 = new Conta(2, 123, 1, "Cliente 02", 50000.0f);
		// visualizamos os dados da conta c2
		c2.visualizar();
//efetuamos um saque na conta c2 e visualizamos o novo saldo
		c2.sacar(1000.0f);
		System.out.println("\n\n" + c2.getSaldo());
		// efetuamos um deposito na conta c1 e visualizamos o novo saldo
		...
		while (true) {
			...
			System.out.println(Cores.TEXT_YELLOW + Cores.ANSI_BLACK_BACKGROUND
					+ "*****************************************************");
			System.out.println("                                                     ");
			System.out.println("                BANCO JAVINHA               ");
			System.out.println("                                                     ");
			System.out.println("*****************************************************");
